...
class FunctionAdapter(var list: MutableList<FunctionData> = mutableListOf()): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        ...
        fun bind(data: FunctionData){
            img.setBackgroundResource(data.icon)
            tvContent.text = data.nameFunction
